...
const resourceTitles: Record<SharedCatalogResourceName, string> = {
  ...
  goods_infos: 'Standard Product Information',
  couriers: 'Couriers',
  courier_pack_rules: 'Courier Packing Rules',
  courier_links: 'Global Courier Links',
...
const messages: Record<string, string> = {
  ...
  'sharedCatalog.domain': 'Shared Product Catalog',
  'menu.sharedCatalog.domain': 'Shared Product Catalog',
  'menu.sharedCatalog': 'Shared Product Catalog',
