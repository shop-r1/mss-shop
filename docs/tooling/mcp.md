...
reported version is not 1.3.6. Install the official release bundle as described
in the generated README before starting Codex from this trusted repository.

The startup contract was verified on 2026-08-27 with the official v1.3.6
